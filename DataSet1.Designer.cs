...
namespace FormularioWin {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class ProductosDataTable : global::System.Data.TypedTableBase<ProductosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductosRow AddProductosRow(string Nombre, decimal Precio, CategoriaRow parentCategoriaRowByFK_Categoria_Productos, string Descripcion, byte[] Imagen) {
                ...
                if ((parentCategoriaRowByFK_Categoria_Productos != null)) {
                    columnValuesArray[3] = parentCategoriaRowByFK_Categoria_Productos[0];
                }
        ...
        public partial class CategoriaRow : global::System.Data.DataRow {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductosRow[] _GetProductosRows() {
...
namespace FormularioWin.DataSet1TableAdapters {
    ...
    public partial class CategoriaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::FormularioWin.Properties.Settings.Default.Conexion;
        }
...
SELECT Id, Nombre, Contraseña FROM Usuarios WHERE (Id = @Id)";
    ...
    public partial class ProductosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Precio", global::System.Data.SqlDbType.Decimal, 0, global::System.Data.ParameterDirection.Input, 9, 3, "Precio", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Productos] ([Nombre], [Precio], [Categoria], [Descripcion], [Imagen]) VALUES (@Nombre, @Precio, @Categoria, @Descripcion, @Imagen);
SELECT idProducto, Nombre, Precio, Categoria, Descripcion, Imagen FROM Productos WHERE (idProducto = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Nombre", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Nombre", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Precio", global::System.Data.SqlDbType.Decimal, 0, global::System.Data.ParameterDirection.Input, 9, 3, "Precio", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Productos] SET [Nombre] = @Nombre, [Precio] = @Precio, [Categoria] = @Categoria, [Descripcion] = @Descripcion, [Imagen] = @Imagen WHERE (([idProducto] = @Original_idProducto) AND ([Nombre] = @Original_Nombre) AND ((@IsNull_Precio = 1 AND [Precio] IS NULL) OR ([Precio] = @Original_Precio)) AND ((@IsNull_Categoria = 1 AND [Categoria] IS NULL) OR ([Categoria] = @Original_Categoria)) AND ((@IsNull_Descripcion = 1 AND [Descripcion] IS NULL) OR ([Descripcion] = @Original_Descripcion)));
SELECT idProducto, Nombre, Precio, Categoria, Descripcion, Imagen FROM Productos WHERE (idProducto = @idProducto)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Nombre", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Nombre", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Precio", global::System.Data.SqlDbType.Decimal, 0, global::System.Data.ParameterDirection.Input, 9, 3, "Precio", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Precio", global::System.Data.SqlDbType.Decimal, 0, global::System.Data.ParameterDirection.Input, 9, 3, "Precio", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT idProducto, Nombre, Precio, Categoria, Descripcion, Imagen FROM dbo.Produc" +
                "tos";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_idProducto, string Original_Nombre, global::System.Nullable<decimal> Original_Precio, global::System.Nullable<int> Original_Categoria, string Original_Descripcion) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string Nombre, global::System.Nullable<decimal> Precio, global::System.Nullable<int> Categoria, string Descripcion, byte[] Imagen) {
            if ((Nombre == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, global::System.Nullable<decimal> Precio, global::System.Nullable<int> Categoria, string Descripcion, byte[] Imagen, int Original_idProducto, string Original_Nombre, global::System.Nullable<decimal> Original_Precio, global::System.Nullable<int> Original_Categoria, string Original_Descripcion, int idProducto) {
            if ((Nombre == null)) {
                throw new global::System.ArgumentNullException("Nombre");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, global::System.Nullable<decimal> Precio, global::System.Nullable<int> Categoria, string Descripcion, byte[] Imagen, int Original_idProducto, string Original_Nombre, global::System.Nullable<decimal> Original_Precio, global::System.Nullable<int> Original_Categoria, string Original_Descripcion) {
            return this.Update(Nombre, Precio, Categoria, Descripcion, Imagen, Original_idProducto, Original_Nombre, Original_Precio, Original_Categoria, Original_Descripcion, Original_idProducto);
        }
    }
